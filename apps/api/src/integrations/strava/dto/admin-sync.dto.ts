/*
# FILE: apps/api/src/integrations/strava/dto/admin-sync.dto.ts
...
# END_MODULE_CONTRACT
# START_MODULE_MAP:
# CLASS 9 [Основной класс модуля.] => AdminSyncDto
# END_MODULE_MAP
# START_USE_CASES:
#- [AdminSyncDto]: Validation Layer -> InitializeModuleComponent -> RuntimeReady
# END_USE_CASES
*/

import { IsDateString, IsOptional, IsUUID } from "class-validator";

// START_CLASS_AdminSyncDto
/*
# START_CONTRACT:
# PURPOSE: Описывает контракт входных и выходных данных домена strava.
