/*
# FILE: apps/api/src/locations/dto/update-location.dto.ts
...
# END_MODULE_CONTRACT
# START_MODULE_MAP:
# CLASS 9 [Основной класс модуля.] => UpdateLocationDto
# CONST 4 [Константа или конфигурационное значение модуля.] => SLUG_REGEX
# END_MODULE_MAP
# START_USE_CASES:
#- [UpdateLocationDto]: Validation Layer -> InitializeModuleComponent -> RuntimeReady
# END_USE_CASES
*/
