...
# END_MODULE_CONTRACT
# START_MODULE_MAP:
# CLASS 9 [Основной класс модуля.] => CreateEventDto
# CONST 4 [Константа или конфигурационное значение модуля.] => SLUG_REGEX
# END_MODULE_MAP
# START_USE_CASES:
#- [CreateEventDto]: Validation Layer -> InitializeModuleComponent -> RuntimeReady
# END_USE_CASES
*/
